...
def get_consent_managers_config():
    """
    Export consent managers configuration for use in audit mode.

    Allows audit modules to reuse CMP detection patterns from consent_managers.yml
    without duplicating the configuration loading logic.

    Returns:
        List of CMP configuration dictionaries
    """
    return get_consent_managers()
